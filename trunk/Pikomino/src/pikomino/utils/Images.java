...
public class Images {
    ...
    static {
        try {
        	...
        	imageDieWorm = ImageIO.read(new File("resources\\Images\\Dice\\DieWorm.png"));
            diceImages.put(6, imageDieWorm);
            imageDie5 = ImageIO.read(new File("resources\\Images\\Dice\\Die5.png"));
            diceImages.put(5, imageDie5);
            imageDie4 = ImageIO.read(new File("resources\\Images\\Dice\\Die4.png"));
            diceImages.put(4, imageDie4);
            imageDie3 = ImageIO.read(new File("resources\\Images\\Dice\\Die3.png"));
            diceImages.put(3, imageDie3);
            imageDie2 = ImageIO.read(new File("resources\\Images\\Dice\\Die2.png"));
            diceImages.put(2, imageDie2);
            imageDie1 = ImageIO.read(new File("resources\\Images\\Dice\\Die1.png"));
            diceImages.put(1, imageDie1);
